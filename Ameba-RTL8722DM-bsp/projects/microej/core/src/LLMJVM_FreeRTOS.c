 ...
 * 1. Add implementation of missing freertos function: xPortIsInsideInterrupt
 *    Link of the function implementation origin: https://github.com/STMicroelectronics/stm32_mw_freertos/blob/master/Source/portable/IAR/ARM_CM33/non_secure/port.c
 */
