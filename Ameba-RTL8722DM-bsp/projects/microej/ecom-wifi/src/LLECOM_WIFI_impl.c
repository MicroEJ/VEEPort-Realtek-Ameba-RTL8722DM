...
int32_t LLECOM_WIFI_IMPL_getCapability(int8_t getResult) {
	// The AmebaD board is able to do station and access point mode in the same time.
	// Check mode RTW_MODE_STA_AP and example `sdk\sdk-amebad_v6.2C-RC\component\common\example\wlan_repeater`.
	return WIFI_CAPABILITY_BOTH_SIMULTANEOUS;
}
