cd /D %2
set tooldir=%2\..\..\..\..\sdk\sdk-amebad_v6.2C-RC\component\soc\realtek\amebad\misc\iar_utility\common\tools
set libdir=%2\..\..\..\..\sdk\sdk-amebad_v6.2C-RC\component\soc\realtek\amebad\misc\bsp
set iartooldir=%3
set build_type=%4
